    ...
    return(
        <div>
            ...
            <div className="   bg-white shadow-2xl w-[454px] h-[572px] absolute top-[180px] left-[520px] ">
               <h1 className="flex  border-b-[0.5px] pb-[20px]  pl-[22px] text-[18px] font-bold font-Roboto gap-[297px] pt-[16px]">Edit Note <XMarkIcon className=" text-[#777777] w-[20px] h-[25px]" onClick={onClose} /> </h1>    
