...
function  Draft () {
   ...
   const [pull, setPull] = useState(false)
    ...
    return (
        ...
        <div className="  bg-white h-73 ">
            <div className="container flex">
                <div>
                  <h1 className=" text-36 py-2 font-Gruppo"> <Link  to="/3Sixty"> 3Sixty</Link> </h1>
                </div>
            
                <span className=" pt-25 pl-129">
                ...
                <div>
                  <h3 className=" text-14 pt-26 pl-19">Search notes</h3>
                </div>
          </div>
        </div>
        <div className="  bg-secondary h-73 ">
            <div className=" container">
                <div className=" flex justify-between">
                <div className=" flex py-7 pl-4">
                    <div className="flex  text-bluedark">
                        <span >
                        ...
                        <h1 className=" pl-8.9 text-15 ">Notes</h1>
                        <p className="   bg-primary w-25 h-25 rounded-full pl-1.8 ml-14">10</p>
                    </div>

                    <div className="flex pl-46">
                        <span>
                        ...
                        <h1 className=" pl-8.9 text-15 text-secondarydark">Todos</h1>
                        <p className="  text-white  bg-secondarydark w-25 h-25 rounded-full pl-1.8 ml-14">10</p>
                    </div>
                    ...
                    <div className="flex  pl-46">
                        ...
                        <h1 className="text-15 pl-8.9 text-secondarydark">Events</h1>
                        <p className="  text-white  bg-secondarydark w-25 h-25 rounded-full pl-2 ml-14">2</p>
                    </div>
                    ...
                    <div className="flex pl-46">
                        ...
                        <h1 className="text-15 pl-8.9 text-secondarydark">Archives</h1>
                        <p className="  text-white  bg-secondarydark w-25 h-25 rounded-full pl-1.8 ml-14">10</p>
                    </div>
                    ...
                    <div className="flex pl-46">
                        ...
                        <h1 className="text-15 pl-8.9 text-secondarydark">Settings</h1>
        ...
        <div className=" flex ">
              ...
              <div className=" container overflow-y-scroll  h-580">
                    <div className=" border-b-2 pb-19 pl-115">
                        <div>
                            ...
                            <p className=" text-13 text-graydark pt-3.9">Incididunt et aliquip sint duis esse. Est duis ea dolor <br></br> eiusmod ut elit incididunt irure nisi duis aliquip <br></br> anim velit. Officia laborum consectetur quis ea <br></br> pariatur proident exercitation. </p>
                        </div>

                        <div className="  flex pt-15 ">
                            <div>
                                <h3  className=" text-bluedark text-13 bg-primary w-86 h-32 rounded-full text-center py-2 font-Roboto">Personal</h3>
                            </div>

                            <div>
                                <h3 className=" pl-69 text-13 font-Roboto text-primarydark pt-2">23 hours ago</h3>
                            </div>

                            <div className=" w-50 h-26  py-3 ml-19  mt-1.5 text-center text-1 bg-ashlight rounded-full" onClick={() =>{setPop(!pop)}}>

                               <svg width="" height="4" viewBox="0 0 13 3" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div className=" border-b-2 pb-19 pl-115">
                        <div>
                            <h1  className=" text-primarylight text-18 font-Roboto font-bold  pt-21 " >Visit Plateau State</h1>
                            <p className=" text-13 text-graydark pt-3.9">Incididunt et aliquip sint duis esse. Est duis ea dolor <br></br> eiusmod ut elit incididunt irure nisi duis aliquip <br></br> anim velit. Officia laborum consectetur quis ea <br></br> pariatur proident exercitation. </p>
                        </div>

                        <div className="  flex pt-15 ">
                            <div>
                                <h3  className=" text-bluedark text-13 bg-primary w-86 h-32 rounded-full text-center py-2 font-Roboto">Travel</h3>
                            </div>
                    ...
                    <div className=" border-b-2 pb-19 pl-115">
                        <div>
                            <h1  className=" text-primarylight text-18 font-Roboto font-bold  pt-21 " >Birthday debrief</h1>
                            <p className=" text-13 text-graydark pt-3.9">Incididunt et aliquip sint duis esse. Est duis ea dolor <br></br> eiusmod ut elit incididunt irure nisi duis aliquip <br></br> anim velit. Officia laborum consectetur quis ea <br></br> pariatur proident exercitation. </p>
                        </div>
                        ...
                        <div className="  flex pt-15 ">
                            ...
                            <div>
                                <h3 className=" pl-69 text-13 font-Roboto text-primarydark pt-2">3 hours ago</h3>
                            </div>
                    ...
                    <div className=" border-b-2 pb-19 pl-115">
                        <div>
                            <h1  className=" text-primarylight text-18 font-Roboto font-bold  pt-21 " >Learn Darts</h1>
                            <p className=" text-13 text-graydark pt-3.9">Incididunt et aliquip sint duis esse. Est duis ea dolor <br></br> eiusmod ut elit incididunt irure nisi duis aliquip <br></br> anim velit. Officia laborum consectetur quis ea <br></br> pariatur proident exercitation. </p>
                        </div>
                    ...
                    <div className=" bg-secondary border-b-2 pb-19 pl-115">
                        <div>
                            <h1  className=" text-primarylight text-18 font-Roboto font-bold  pt-21 " >10 Hours Fasting every week</h1>
                            <p className=" text-13  text-graydark pt-3.9">Incididunt et aliquip sint duis esse. Est duis ea dolor <br></br> eiusmod ut elit incididunt irure nisi duis aliquip <br></br> anim velit. Officia laborum consectetur quis ea <br></br> pariatur proident exercitation. </p>
                        </div>
           ...
           <div>
               <div>
                    <p className=' bg-white w-39 h-39  rounded-full pt-17 pl-14 ml-7 mt-5' onClick={() =>{setPup(!pup)}}>
                    ...
                    <div className=' bg-white w-41 h-85 ml-7 mt-6 rounded-t-full rounded-b-full '>
                        <p className=' pl-3 pt-5 border-b-2 pb-1.5'>
        ...
        <div className={`dropdown-menu ${pop? 'active' : 'inactive'}`} >
        <div className= ' bg-white  w-143 h-124 ml-20  absolute left-172  bottom-262  shadow-2xl '>
            <div className='flex pt-2 pl-5'>
                ...
                <h3 className=' pl-4 cursor-pointer text-bluedark text-13'>Edit</h3>
            </div>
            ...
            <div className='flex pt-1 pl-5'>
                ...
                <h3 className=' pl-4 pt-1 cursor-pointer text-primarydark text-13'>Delete</h3>
            </div>
            ...
            <div className='flex pt-1 pl-5'>
                ...
                <h3 className=' pl-4 pt-1 cursor-pointer text-primarydark text-13'>Print</h3>
            </div>
            <div className='flex pt-1 pl-5'>
                <p className=' pt-2'>
                ...
                <h3 className=' pl-4 pt-1  cursor-pointer text-primarydark text-13'>Archive</h3>
            </div>
        </div>
        </div>
        ...
        <div className={`dropdown-menu ${pup? 'active' : 'inactive'}`}>
        <div className= ' bg-white  w-200 h-160 ml-20  absolute bottom-374  left-999 shadow-2xl '>
            <div className='flex pt-2 pl-5'>
                <p className=' pt-1'>
                    <svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M10.8901 0.389997L13.6001 3.11C14.0601 3.57 14.0201 4.35 13.6301 4.75L5.62006 12.77L0.0600586 13.93L1.22006 8.35C1.22006 8.35 8.82006 0.719997 9.21006 0.319997C9.60006 -0.0700034 10.4301 -0.0700033 10.8901 0.389997ZM8.16006 3.18L2.57006 8.79L3.68006 9.9L9.22006 4.25L8.16006 3.18ZM5.19006 11.41L10.7701 5.81L9.70006 4.73L4.11006 10.33L5.19006 11.41Z" fill="#356DFB"/>
            ...
            <div className='flex pt-1 pl-5'>
                ...
                <h3 className=' pl-4 pt-3 cursor-pointer text-primarydark text-13'>Delete</h3>
            </div>
            ...
            <div className='flex pt-1 pl-5'>
                ...
                <h3 className=' pl-4 pt-3 cursor-pointer text-primarydark text-13'>Print</h3>
            </div>
            <div className='flex pt-1 pl-5'>
                <p className=' pt-4'>
                   <svg width="17" height="14" viewBox="0 0 17 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <h3 className=' pl-4  pt-3 cursor-pointer text-primarydark text-13'>Archive</h3>
            </div>
        </div>
        </div>
