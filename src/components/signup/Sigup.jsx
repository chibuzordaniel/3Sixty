       ...
       <div className=' absolute top-[22px] left-[600px]  '>
        <div className=" bg-white rounded-2xl shadow-2xl h-[719px] w-[365px]   ">
           <div className=''>
               ...
               <form action="">
                  <div>
                     <input className=' border  outline-none border-[#DEDFEC] text-[14px] text-[#BDBEC1]  bg-[#f9f9f9]  font-Roboto   rounded-xl mt-[23px] w-[314px] h-[46px] ml-[26px] pl-[17px] capitalize '  placeholder='Name' type="name" required />
                     <input className=' border  outline-none border-[#DEDFEC] text-[14px] text-[#BDBEC1]  bg-[#f9f9f9]  font-Roboto   rounded-xl mt-[20px] w-[314px] h-[46px] ml-[26px] pl-[17px] capitalize '  placeholder='Username' type="username" required />
                     <input className=' border  outline-none border-[#DEDFEC] text-[14px] text-[#BDBEC1]  bg-[#f9f9f9]  font-Roboto   rounded-xl mt-[20px] w-[314px] h-[46px] ml-[26px] pl-[17px] capitalize '  placeholder='E-mail' type="email" required />
                     <input className=' border  outline-none border-[#DEDFEC] text-[14px] text-[#BDBEC1]  bg-[#f9f9f9]  font-Roboto   rounded-xl mt-[20px] w-[314px] h-[46px] ml-[26px] pl-[17px] capitalize '  placeholder='Password' type="password" required />
                     <button className=' bg-[#356DFB]  w-[314px] h-[46px] rounded-full ml-[26px] text-[16px] text-white mt-[29px] font-Roboto '> <Link to='/Draft'>Sign Up</Link></button>
