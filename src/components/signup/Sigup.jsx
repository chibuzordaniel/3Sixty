...
function Signup ({visible, onClose}) {
   ...
   return (
     <div id='Signup'  onClick={windowClose} className=' bg-[#00000033] w-full h-full  absolute top-0 '>
       <div className=' absolute top-[30px] left-[520px]  '>
        <div className=" bg-white rounded-2xl shadow-2xl h-[650px] w-[365px]   ">
           <div className=''>
               ...
               <p className='text-[13px] text-[#777777] pl-[26px] pt-[12px]  '>Enter your personal details to start your journey today</p>
               ...
               <div className=' flex ml-[105px] mt-[12px]  '>
               ...
               <form action="">
                  <div>
                     <input className=' border  outline-none border-[#DEDFEC] text-[14px] text-[#BDBEC1]  bg-[#f9f9f9]  font-Roboto   rounded-xl mt-[15px] w-[314px] h-[46px] ml-[26px] pl-[17px] capitalize '  placeholder='Name' type="text" required />
                     <input className=' border  outline-none border-[#DEDFEC] text-[14px] text-[#BDBEC1]  bg-[#f9f9f9]  font-Roboto   rounded-xl mt-[15px] w-[314px] h-[46px] ml-[26px] pl-[17px] capitalize '  placeholder='Username' type="text" required />
                     <input className=' border  outline-none border-[#DEDFEC] text-[14px] text-[#BDBEC1]  bg-[#f9f9f9]  font-Roboto   rounded-xl mt-[15px] w-[314px] h-[46px] ml-[26px] pl-[17px] capitalize '  placeholder='E-mail' type="text" required />
                     <input className=' border  outline-none border-[#DEDFEC] text-[14px] text-[#BDBEC1]  bg-[#f9f9f9]  font-Roboto   rounded-xl mt-[15px] w-[314px] h-[46px] ml-[26px] pl-[17px] capitalize '  placeholder='Password' type="text" required />
